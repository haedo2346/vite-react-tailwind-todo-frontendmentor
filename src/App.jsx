      ...
      <main className="container mx-auto mt-8 px-4">
        <div className="rounded-md bg-white">
          <article className="flex gap-4 border-b border-b-gray-400 px-4 py-4">
            <button className="flex h-5 w-5 flex-none rounded-full border-2 "></button>
          ...
          <article className="flex gap-4 border-b border-b-gray-400 px-4 py-4">
            <button className="flex h-5 w-5 rounded-full border-2 "></button>
            <p className="grow text-gray-600">
              complete online JS curse in bluuweb
            </p>
            <button className="flex-none">
